...
class ModuleRunEndpoint(ModuleEndpoint):

    def __init__(self, ipv8):
        ModuleEndpoint.__init__(self, ipv8)

    def getChild(self, path, request):
        return ModuleRunCreatorEndpoint(self.ipv8, path)


class ModuleRunCreatorEndpoint(ModuleEndpoint):
    ...
    def getChild(self, path, request):
        return ModuleRunContentHashEndpoint(self.ipv8, self._creator, path)


class ModuleRunContentHashEndpoint(ModuleEndpoint):
    ...
    def render_GET(self, request):
        ...
        self.get_module_overlay().run_module(self._identifier)
